...
use ibc::core::client::context::client_state::{ClientState, ClientStateValidation};
...
where
    ...
    HostClientState<H, MockStore>:
        ClientStateValidation<DefaultIbcStore<H::ClientState, HostConsensusState<H, MockStore>>>,
